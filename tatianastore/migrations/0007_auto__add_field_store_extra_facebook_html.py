...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.extra_facebook_html'
        db.add_column(u'tatianastore_store', 'extra_facebook_html',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.extra_facebook_html'
        db.delete_column(u'tatianastore_store', 'extra_facebook_html')
    ...
    models = {
        ...
        u'tatianastore.album': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('c273fd34-da43-43dd-bcaf-df5d0cc31285')", 'max_length': '64', 'blank': 'True'}),
        ...
        u'tatianastore.downloadtransaction': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('e14cdd2d-7fde-4948-b0fb-31bd9df30cd3')", 'max_length': '64', 'blank': 'True'})
        },
        ...
        u'tatianastore.song': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tatianastore.Store']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a1c19daa-5fdc-4604-b7ba-6e1ac2a40e02')", 'max_length': '64', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'tatianastore.store': {
            ...
            'extra_facebook_html': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'extra_html': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'facebook_data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
