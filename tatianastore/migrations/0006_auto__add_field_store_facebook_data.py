...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.facebook_data'
        db.add_column(u'tatianastore_store', 'facebook_data',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.facebook_data'
        db.delete_column(u'tatianastore_store', 'facebook_data')
    ...
    models = {
        ...
        u'tatianastore.album': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d43648a1-9a3b-456f-bc75-82473b4fbecb')", 'max_length': '64', 'blank': 'True'}),
        ...
        u'tatianastore.downloadtransaction': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('60bb0acd-f1c7-4b34-b5b5-ef000aa10ba8')", 'max_length': '64', 'blank': 'True'})
        },
        ...
        u'tatianastore.song': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tatianastore.Store']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('cd322d60-f901-44b0-8cc6-d7fca33a4ef0')", 'max_length': '64', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
