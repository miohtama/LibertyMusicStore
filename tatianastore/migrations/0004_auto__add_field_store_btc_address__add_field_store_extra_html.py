...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.btc_address'
        db.add_column(u'tatianastore_store', 'btc_address',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.extra_html'
        db.add_column(u'tatianastore_store', 'extra_html',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.btc_address'
        db.delete_column(u'tatianastore_store', 'btc_address')

        # Deleting field 'Store.extra_html'
        db.delete_column(u'tatianastore_store', 'extra_html')
    ...
    models = {
        ...
        u'tatianastore.album': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('10ce3ce1-e4ec-4d82-bcbb-8b904f19ddbd')", 'max_length': '64', 'blank': 'True'}),
        ...
        u'tatianastore.downloadtransaction': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('71f9c9de-dbff-4101-b7ba-0e27cb183b96')", 'max_length': '64', 'blank': 'True'})
        },
        ...
        u'tatianastore.song': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tatianastore.Store']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('af99130a-da6a-4c68-819f-3c897f2a1b0c')", 'max_length': '64', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'tatianastore.store': {
            ...
            'extra_html': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
