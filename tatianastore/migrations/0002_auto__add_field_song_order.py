...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tatianastore_song', 'order',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'tatianastore_song', 'order')
    ...
    models = {
        ...
        u'tatianastore.album': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('c8e8f792-7815-45b0-aa5c-6ae13058cae2')", 'max_length': '64', 'blank': 'True'})
        },
        u'tatianastore.downloadtransaction': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('302d2982-415f-4e2d-b451-91a1e7ae2d16')", 'max_length': '64', 'blank': 'True'})
        },
        ...
        u'tatianastore.song': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tatianastore.Store']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4366b77f-6e02-43d4-9614-e295c5ce0344')", 'max_length': '64', 'blank': 'True'})
        },
